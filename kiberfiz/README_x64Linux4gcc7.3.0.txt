...
data type Current from schema.idl.
This example builds two applications, named CurrentPublisher
and CurrentSubscriber.
...
command shell, type:
> make -f makefile_schema_x64Linux4gcc7.3.0

To Modify the Data:
===================
To modify the data being sent, in the default package (or module you specified),
open/double-click and edit the CurrentPublisher.java file
where it says:
...
-------------
Type 
> ant CurrentPublisher
or
> ant CurrentSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the CurrentPublisher or CurrentSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_schema_x64Linux4gcc7.3.0 CurrentPublisher
> make -f makefile_schema_x64Linux4gcc7.3.0 CurrentSubscriber
