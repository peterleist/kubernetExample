...
public class PowerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Power";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PowerTypeSupport _singleton
    = new PowerTypeSupport();
    ...
    */
    public static PowerTypeSupport get_instance() {
        return _singleton;
    }

    public static PowerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PowerTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Power</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Power typedDst = (Power) destination;
        Power typedSrc = (Power) source;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.PValue);
            if(!xcdr1){            
    ...
    int mask) {
        return new PowerDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PowerDataReader(native_reader, listener, mask, this);   
    ...
    protected PowerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, PowerTypeCode.VALUE, Power.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PowerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, PowerTypeCode.VALUE, Power.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
