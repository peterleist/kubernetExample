...
public class  VoltageTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("USensorID", false, (short)-1,  false, TypeCode.TC_LONG, 1, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("UValue", false, (short)-1,  false, TypeCode.TC_FLOAT, 2, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("Voltage",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);        
        return tc;
    }
}
