...
public class VoltageTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final VoltageTypeSupport _singleton
    = new VoltageTypeSupport();
    ...
    */
    public static VoltageTypeSupport get_instance() {
        return _singleton;
    }

    public static VoltageTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return VoltageTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return Voltage.create();
    }
    ...
    * <code>this</code> is not a <code>Voltage</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Voltage typedDst = (Voltage) destination;
        Voltage typedSrc = (Voltage) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Voltage typedSrc = (Voltage) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.USensorID);
            dst.writeFloat(typedSrc.UValue);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.USensorID = src.readInt();
                typedDst.UValue = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Voltage typedDst = (Voltage) sample;
            deserialize_sample(
    ...
    int mask) {
        return new VoltageDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new VoltageDataReader(native_reader, listener, mask, this);   
    ...
    protected VoltageTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, VoltageTypeCode.VALUE, Voltage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected VoltageTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, VoltageTypeCode.VALUE, Voltage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
