...
public class CurrentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Current";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CurrentTypeSupport _singleton
    = new CurrentTypeSupport();
    ...
    */
    public static CurrentTypeSupport get_instance() {
        return _singleton;
    }

    public static CurrentTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CurrentTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Current</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Current typedDst = (Current) destination;
        Current typedSrc = (Current) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Current typedSrc = (Current) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.ISensorID);
            dst.writeFloat(typedSrc.IValue);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.ISensorID = src.readInt();
                typedDst.IValue = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Current typedDst = (Current) sample;
            deserialize_sample(
    ...
    int mask) {
        return new CurrentDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CurrentDataReader(native_reader, listener, mask, this);   
    ...
    protected CurrentTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CurrentTypeCode.VALUE, Current.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CurrentTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, CurrentTypeCode.VALUE, Current.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
