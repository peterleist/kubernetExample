...
/* CurrentSubscriber.java

A publication of data of type Current
...
Example publication of type Current automatically generated by 
...
java CurrentSubscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Connext with the command
java CurrentPublisher <domain_id> <sample_count>
...
java -Djava.ext.dirs=$NDDSHOME/class CurrentPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/class CurrentSubscriber <domain_id>  
*/
...
public class CurrentSubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("Current subscriber sleeping for "
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((Current)_dataSeq.get(i)).toString("Received",0));
