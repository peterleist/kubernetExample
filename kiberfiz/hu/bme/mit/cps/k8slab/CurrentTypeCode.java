...
public class  CurrentTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("ISensorID", false, (short)-1,  false, TypeCode.TC_LONG, 1, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("IValue", false, (short)-1,  false, TypeCode.TC_FLOAT, 2, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("Current",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);        
        return tc;
    }
}
