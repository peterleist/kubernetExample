...
java -Djava.ext.dirs=$NDDSHOME/lib/java CurrentPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java CurrentSubscriber <domain_id>        
*/
...
public class CurrentPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("Writing Current, count " + count);
