...
/**
* A sequence of Power instances.
*/
public final class PowerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PowerSeq (int initialMaximum) {
        super(Power.class, initialMaximum);
    }

    public PowerSeq (Collection<?> elements) {
        super(Power.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Power objects (beyond the original size of this object)
