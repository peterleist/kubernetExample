...
java -Djava.ext.dirs=$NDDSHOME/lib/java EntryPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java EntrySubscriber <domain_id>        
*/
...
public class EntryPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("Writing Entry, count " + count);
