...
public class EntryTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final EntryTypeSupport _singleton
    = new EntryTypeSupport();
    ...
    */
    public static EntryTypeSupport get_instance() {
        return _singleton;
    }

    public static EntryTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EntryTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Entry</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Entry typedDst = (Entry) destination;
        Entry typedSrc = (Entry) source;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.ECalendarID);
            dst.writeFloat(typedSrc.EValue);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.ECalendarID = src.readInt();
                typedDst.EValue = src.readFloat();
    ...
    int mask) {
        return new EntryDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EntryDataReader(native_reader, listener, mask, this);   
    ...
    protected EntryTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, EntryTypeCode.VALUE, Entry.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EntryTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, EntryTypeCode.VALUE, Entry.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
