...
/* EntrySubscriber.java

A publication of data of type Entry
...
Example publication of type Entry automatically generated by 
...
java EntrySubscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Connext with the command
java EntryPublisher <domain_id> <sample_count>
...
java -Djava.ext.dirs=$NDDSHOME/class EntryPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/class EntrySubscriber <domain_id>  
*/
...
public class EntrySubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("Entry subscriber sleeping for "
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((Entry)_dataSeq.get(i)).toString("Received",0));
