...
public class AdjustmentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Adjustment";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AdjustmentTypeSupport _singleton
    = new AdjustmentTypeSupport();
    ...
    */
    public static AdjustmentTypeSupport get_instance() {
        return _singleton;
    }

    public static AdjustmentTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AdjustmentTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Adjustment</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Adjustment typedDst = (Adjustment) destination;
        Adjustment typedSrc = (Adjustment) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Adjustment typedSrc = (Adjustment) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.AValue);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Adjustment typedDst = (Adjustment) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Adjustment typedDst = (Adjustment) sample;
            deserialize_sample(
    ...
    int mask) {
        return new AdjustmentDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AdjustmentDataReader(native_reader, listener, mask, this);   
    ...
    protected AdjustmentTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, AdjustmentTypeCode.VALUE, Adjustment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AdjustmentTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, AdjustmentTypeCode.VALUE, Adjustment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
