...
/**
* A sequence of Entry instances.
*/
public final class EntrySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EntrySeq (int initialMaximum) {
        super(Entry.class, initialMaximum);
    }

    public EntrySeq (Collection<?> elements) {
        super(Entry.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Entry objects (beyond the original size of this object)
