...
public class TemperatureTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final TemperatureTypeSupport _singleton
    = new TemperatureTypeSupport();
    ...
    */
    public static TemperatureTypeSupport get_instance() {
        return _singleton;
    }

    public static TemperatureTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TemperatureTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Temperature</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Temperature typedDst = (Temperature) destination;
        Temperature typedSrc = (Temperature) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += _cdrPrimitiveType.getLongMaxSizeSerialized(currentAlignment) ;
        currentAlignment += _cdrPrimitiveType.getIntMaxSizeSerialized(currentAlignment) ;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Temperature typedSrc = (Temperature) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getLongMaxSizeSerialized(epd.getAlignment(currentAlignment));
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.TSensorID);
            dst.writeFloat(typedSrc.TValue);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.TSensorID = src.readInt();
                typedDst.TValue = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Temperature typedDst = (Temperature) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TemperatureDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TemperatureDataReader(native_reader, listener, mask, this);   
    ...
    protected TemperatureTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TemperatureTypeCode.VALUE, Temperature.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TemperatureTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TemperatureTypeCode.VALUE, Temperature.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
