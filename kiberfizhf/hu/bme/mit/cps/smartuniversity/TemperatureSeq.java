...
/**
* A sequence of Temperature instances.
*/
public final class TemperatureSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TemperatureSeq() {
        super(Temperature.class);
    }

    public TemperatureSeq (int initialMaximum) {
        super(Temperature.class, initialMaximum);
    }

    public TemperatureSeq (Collection<?> elements) {
        super(Temperature.class, elements);
    }

    public  Temperature get(int index) { 
        return (Temperature) super.get(index); 
    }
