...
public class  TemperatureTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("TSensorID", false, (short)-1,  false, TypeCode.TC_LONG, 1, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("TValue", false, (short)-1,  false, TypeCode.TC_FLOAT, 2, false, memberAnnotation);__i++;
