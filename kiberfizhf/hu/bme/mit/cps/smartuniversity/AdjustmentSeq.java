...
/**
* A sequence of Adjustment instances.
*/
public final class AdjustmentSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AdjustmentSeq() {
        super(Adjustment.class);
    }

    public AdjustmentSeq (int initialMaximum) {
        super(Adjustment.class, initialMaximum);
    }

    public AdjustmentSeq (Collection<?> elements) {
        super(Adjustment.class, elements);
    }

    public  Adjustment get(int index) { 
        return (Adjustment) super.get(index); 
    }
