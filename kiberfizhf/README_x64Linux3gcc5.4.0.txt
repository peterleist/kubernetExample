...
data type Entry from schema.idl.
This example builds two applications, named EntryPublisher
and EntrySubscriber.
...
command shell, type:
> make -f makefile_schema_x64Linux3gcc5.4.0

To Modify the Data:
===================
To modify the data being sent, in the default package (or module you specified),
open/double-click and edit the EntryPublisher.java file
where it says:
...
Run with Eclipse:
-----------------
Select Run > Run and choose either the EntryPublisher or EntrySubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_schema_x64Linux3gcc5.4.0 EntryPublisher
> make -f makefile_schema_x64Linux3gcc5.4.0 EntrySubscriber
